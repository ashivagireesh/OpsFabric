...
export const EXPRESSION_FUNCTION_SNIPPETS: Array<{ label: string; snippet: string }> = [
  ...
  { label: 'append_unique(prev_path,obj)', snippet: "append_unique(prev('${1:workflow}', array()), obj(${2:workflow_id}=${3:str(randint(100000000000000,999999999999999))}, ${4:startdate}=${5:now()}, ${6:enddate}=${7:null}, ${8:status}=${9:'active'}))" },
  ...
  { label: 'anomaly_detection(path,key,value,time,obj)', snippet: "anomaly_detection('${1:anomaly}', ${2:field('TRANSACTIONID')}, ${3:num(field('AMOUNT'),0)}, ${4:field('MIS_TXNDATE')}, obj(partition_by=array(${5:field('CUSTACCOUNTNUMBER')}, ${6:field('SERVICENAME')}, ${7:field('TXN_TYPE')}),window='${8:30d}',min_count=${9:5},method='${10:zscore}',z_threshold=${11:2},very_high_z_threshold=${12:3},allowed_lateness='${13:2d}'))" },
